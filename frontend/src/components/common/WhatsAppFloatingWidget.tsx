  ...
  return (
    <div ref={widgetRef} className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 font-sans">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.94 }}
        className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] hover:bg-[#1EBE5D] text-white shadow-[0_8px_25px_rgba(37,211,102,0.45)] flex items-center justify-center transition-all duration-300 border-2 border-white cursor-pointer group"
      ...
      >
        ...
        {/* Unread count badge */}
        {!isOpen && (
          <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-red-600 text-white text-[10px] font-bold flex items-center justify-center border-2 border-white shadow-sm">
            2
          </span>
        )}
